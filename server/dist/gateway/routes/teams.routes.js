...
const teams_schemas_1 = require("../../schemas/teams.schemas");
...
router.get('/by-repo/:repoId', (0, validate_middleware_1.validateParams)(common_schemas_1.repoIdParams), teams_controller_1.TeamsController.findByRepoId);
router.post('/join', (0, validate_middleware_1.validateBody)(teams_schemas_1.joinTeamBody), teams_controller_1.TeamsController.join);
